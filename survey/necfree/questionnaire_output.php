...
<head>
  <title>Necfree頸站頂天車枕，讓您一路神采飛揚</title>
  <meta charset="utf-8" />
...
<script>
  ...
  fbq('init', '1241916676318365');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"

src="https://www.facebook.com/tr?id= 1241916676318365&ev=PageView&noscript=1"/>
</noscript>
...
if(isset($_REQUEST['question7_1'])) $question7_1 = $_REQUEST["question7_1"];
else $question7_1 = "";
if(isset($_REQUEST['question7_2'])) $question7_2 = $_REQUEST["question7_2"];
else $question7_2 = "";
if(isset($_REQUEST['question7_3'])) $question7_3 = $_REQUEST["question7_3"];
else $question7_3 = "";
if(isset($_REQUEST['question7_4'])) $question7_4 = $_REQUEST["question7_4"];
else $question7_4 = "";
if(isset($_REQUEST['question7_5'])) $question7_5 = $_REQUEST["question7_5"];
else $question7_5 = "";
if(isset($_REQUEST['question7_6'])) $question7_6 = $_REQUEST["question7_6"];
else $question7_6 = "";
if(isset($_REQUEST['question7_7'])) $question7_7 = $_REQUEST["question7_7"];
else $question7_7 = "";

if(isset($_REQUEST['question8_1'])) $question8_1 = $_REQUEST["question8_1"];
else $question8_1 = "";
if(isset($_REQUEST['question8_2'])) $question8_2 = $_REQUEST["question8_2"];
else $question8_2 = "";
if(isset($_REQUEST['question8_3'])) $question8_3 = $_REQUEST["question8_3"];
else $question8_3 = "";
if(isset($_REQUEST['question8_4'])) $question8_4 = $_REQUEST["question8_4"];
else $question8_4 = "";
if(isset($_REQUEST['question8_5'])) $question8_5 = $_REQUEST["question8_5"];
else $question8_5 = "";

if(isset($_REQUEST['question9'])) $question9 = $_REQUEST["question9"];
else $question9 = "";

if(isset($_REQUEST['question10'])) $question10 = $_REQUEST["question10"];
else $question10 = "";
...
$sql = $pdo -> prepare('insert necfree_q values(
  null,?, ?,
  		  ?,?,?,?,
		  ?,?,?,?,?,?,?,
		  ?,?,?,?,?,?,
...
if($sql->execute([date("YmdHis"), 
	...
	$question3_1, $question3_2, $question3_3, $question3_4, $question3_5, $question3_6, $question3_text, 
	$question4_1, $question4_2, $question4_3, $question4_4, $question4_5, $question4_6, 
	$question5, $question6, 
	$question7_1, $question7_2, $question7_3, $question7_4, $question7_5, $question7_6, $question7_7, 
	$question8_1, $question8_2, $question8_3, $question8_4, $question8_5, 
