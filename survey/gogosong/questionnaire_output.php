...
<html>
    ...
    fbq('init', '858536651448444');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1774776935968195&ev=PageView&noscript=1"
    /></noscript>
...
if(isset($_REQUEST['question1_7'])) $question1_7 = $_REQUEST["question1_7"];
else $question1_7 = "";
...
if(isset($_REQUEST['question2_6'])) $question2_6 = $_REQUEST["question2_6"];
else $question2_6 = "";
...
$sql = $pdo -> prepare('insert gogosong_q values(
	null,?, ?,?,?,?,?,?,?,
		  ?,?,?,?,?,?,
		  ?,?,?,?,?,
		  ?,?,?,?,?,?,?,
...
if($sql->execute([date("YmdHis"), 
	...
	$question4_1, $question4_2, $question4_3, $question4_4, $question4_5, $question4_6, $question4_7, 
	$question5, $question6, $question7, $question8, $email, $tel, $message
])) {
	// $key = 123456;
	// $point_url = "";
	// while(TRUE) {
...
?>
	<body class="landing is-preload">
      ...
      <div>
        <picture>
          <source class="logo" media="(max-width: 799px)" srcset="images/finish/logo-m.png">
          <source class="logo" media="(min-width: 800px)" srcset="images/finish/logo.png">
          <img class="logo" class="logo" data-src="images/home/logo.png"/>
        </picture></div>
      <div class="btn-bk"><a href="https://www.facebook.com/JTSGogoSong"><img class="button" src="images/finish/button.png"/></a></div>     
	</body>
</html>