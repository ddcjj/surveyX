...
<html>
	<head>
		<title>ERICA LIBERT'E 太陽能鳳梨皮帶腕錶</title>
		<meta charset="utf-8"/>
...
$sql = $pdo -> prepare('insert erica_q values(
	null, ?,?,?,?,?,
		  ?,?,?,?,?,
		  ?,?,?,?,?,
		  ?,?,?,?,?,
...
if($sql->execute([date("YmdHis"), 
	$question1, $question2_1, $question2_2, $question2_3, $question2_4,
...
?>
	<body class="landing is-preload">
      ...
      <div class="main">
        ...
        <div class="btn-bk">
          <a href="https://www.facebook.com/erica.pinewatch/posts/123147993317395">
            <picture>
              ...
              <img class="button" data-src="images/finish/button.png"/>
            </picture>
          </a>        
        </div>   
      </div>       
