...
$sql_q = $pdo_q->prepare('insert into pekora_ha↗ha↘ha↗ha↘_q values(null ,? , ?, ?, ?, ?, ?, ?)');
    if($sql_q->execute([date("YmdHis"), $question1, $question2_1, $question2_2, $question2_3, $question2_4, $question3])){
				...
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
							...
							<div>
								<ul class="box">
									<li><a href="https://www.surveyx.tw" class="button primary">加好友</a></li>
								</ul>
							</div>
						</header>
					</section>
