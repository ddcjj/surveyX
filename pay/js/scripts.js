...
function clickGold() {
    document.getElementById('_62').src="images/ID1@2x.png";
}
function clickAqua() {
    document.getElementById('_62').src="images/ID3@2x.png";
}
function clickSliver() {
    document.getElementById('_62').src="images/ID2@2x.png";
}
function clickRose() {
    document.getElementById('_62').src="images/ID4@2x.png";
}
function onclickFeature() {
    document.getElementById('details-lightbox-1').style.visibility="visible";
}