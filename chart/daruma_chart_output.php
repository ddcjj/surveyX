...
$sql = "SELECT column_name FROM information_schema.columns 
    WHERE table_schema = 'surveyx_questionnaire' AND table_name = 'daruma_q';";
...
for($i=1; $i<=4; $i+=1) {
    $sql_q6 .= ',count(if ('.$col_name[$i+11].'='.$i.',true,null))';
}
$sql_q6 .= ' from daruma_q;';
...
for($i=1; $i<=3; $i+=1) {
    $sql_q7 .= ',count(if ('.$col_name[16].'='.$i.',true,null))';
}
$sql_q7 .= ' from daruma_q;';
...
for($i=1; $i<=6; $i+=1) {
    $sql_q8 .= ',count(if ('.$col_name[17].'='.$i.',true,null))';
}
$sql_q8 .= ' from daruma_q;';
    ...
    <body class="is-preload" style="background-color: white;">
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '相較一般電源延長線，您會想要【真好用 便利換 延長線】以下哪些功能？',
                    left: 'center'
                },
                xAxis: {
                    type: 'category',
                    data: ['可拔插式U...','可拔插式U...','60w快充...','可更換模組...','有過載保護...','特別顏色成...'],
                    axisTick: {
                        alignWithLabel: true
                    }
                },
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '以下哪個會是影響您購買【真好用 便利換 延長線】的主要因素？',
                    left: 'center'
                },
                tooltip: {
                    trigger: 'item'
                ...
                series: [
                    {
                        ...
                        radius: '50%',
                        data: [
                            {value: <?php echo $row_q2[1] ?>, name: '顏色'},
                            {value: <?php echo $row_q2[2] ?>, name: '價格'}
                        ],
                        emphasis: {
                            itemStyle: {
                                shadowBlur: 10,
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '如果你想購買【真好用 便利換 延長線】，你會喜歡它是什麼顏色？',
                    left: 'center'
                },
                tooltip: {
                    trigger: 'item'
                ...
                series: [
                    {
                        ...
                        radius: '50%',
                        data: [
                            {value: <?php echo $row_q3[1] ?>, name: '酷炫黑'},
                            {value: <?php echo $row_q3[2] ?>, name: '珍珠白'},
                            {value: <?php echo $row_q3[3] ?>, name: '甜心粉'},
                            {value: <?php echo $row_q3[4] ?>, name: 'Tiffa...'}
                        ],
                        emphasis: {
                            itemStyle: {
                                shadowBlur: 10,
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '如果您想購買【真好用 便利換 延長線】，您會願意花多少錢選購？',
                    left: 'center'
                },
                tooltip: {
                    trigger: 'item'
                ...
                series: [
                    {
                        ...
                        radius: '50%',
                        data: [
                            {value: <?php echo $row_q4[1] ?>, name: '1890元...'},
                            {value: <?php echo $row_q4[2] ?>, name: '2290元...'},
                            {value: <?php echo $row_q4[3] ?>, name: '2690元...'},
                            {value: <?php echo $row_q4[3] ?>, name: '沒有購買意...'}
                        ],
                        emphasis: {
                            itemStyle: {
                                shadowBlur: 10,
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '如果可以制定組合，您會想要以下哪種【真好用 便利換 延長線】組合？',
                    left: 'center'
                },
                tooltip: {
                    trigger: 'item'
                ...
                series: [
                    {
                        ...
                        radius: '50%',
                        data: [
                            {value: <?php echo $row_q5[1] ?>, name: 'AAA'},
                            {value: <?php echo $row_q5[2] ?>, name: 'CCC'},
                            {value: <?php echo $row_q5[3] ?>, name: '2A1C'},
                            {value: <?php echo $row_q5[4] ?>, name: '2C1A'}
                        ],
                        emphasis: {
                            itemStyle: {
                                shadowBlur: 10,
        ...
        <script type="text/javascript">
            ...
            option = {
                ...
                title: {
                    text: '您會喜歡【真好用 便利換 延長線】還有什麼以下功能？',
                    left: 'center'
                },
                xAxis: {
                    type: 'category',
                    data: ['可無線充電','有小夜燈模...','蚊香片模組','小型風扇模...'],
                    axisTick: {
                        alignWithLabel: true
                    }
                },
                ...
                series: [{
                    data: <?php echo json_encode(array_splice($row_q6, 1)); ?>,
                    type: 'bar'
                }]
            };
            option && myChart.setOption(option);
